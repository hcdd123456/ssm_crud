...
<%--		  	客户手机：<input type="text" name="telephone" class="easyui-validatebox" data-options="required:true"/><br/>--%>
		  	客户年龄：<input type="text" name="age" class="easyui-validatebox" data-options="required:true"/><br/>
  	...
  	<script type="text/javascript">
  		$(function(){
  			...
  			$("#editBtn").click(function(){
  				...
  				//表单回显
  				$("#editForm").form("load","user/findById?id="+rows[0].id);
  			...
  			$("#deleteBtn").click(function(){
  				...
  				$.messager.confirm("提示","确认删除数据吗?",function(value){
  					if(value){
  						...
  						//传递到后台
  						$.post("user/delete",idStr,function(data){
  							if(data.success){
  	  							//刷新datagrid
  	  							$("#list").datagrid("reload");
